...
std::unordered_map<std::pair<size_t, TokenType>, Action, PairHash> actionTable {
	...
	{{ 28, t_DIVIDE }, {SHIFT, 11 }}, {{ 13, t_MINUS }, {SHIFT, 10 }},
	...
	{{ 39, t_TIMES }, {SHIFT, 34 }}, {{ 1, t_PLUS }, {SHIFT, 12 }},
	...
	{{ 2, t_EOF }, {REDUCE, 2 }}, {{ 29, t_TIMES }, {SHIFT, 14 }},
	...
	{{ 39, t_RP }, {REDUCE, 0 }}, {{ 39, t_DIVIDE }, {SHIFT, 31 }},
